  ...
  export default {
    ...
    methods: {
      ...
      classBtn: function (btn) {
        return 'btn'; }, //this.key===btn.key ? 'btn-active' : 'btn'; },
...
<style lang="less">
  ...
  .btn {
    ...
    padding-left:@btn-pad*1.5; padding-top:@btn-pad-top; padding-bottom:@btn-pad-bottom;
    cursor: pointer;
  ...
  .btn .image { float:left; align-self:center; margin-right: @btn-pad; .image-radius; height:100%; }
