...
import Port from '../main/Port.vue'
...
let Color = {
  ...
  setup() {
    ...
    onMounted( () => { // Follow up with the last Nav.pub(obj) that mounted this vue component
      ...
      nav.subscribe(  'Nav', 'Color.vue', (obj) => {
        onNav(obj); } ); } )
...
.color-pane { position:absolute; left:0; top:0; width:100%; height:100%;display:grid;
