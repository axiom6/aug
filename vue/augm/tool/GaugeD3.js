...
const drawGauge = function(opt,g) {
...
//let selector = elem !== null ? elem : "#" + opt.divID
//d3.select(selector)
//   .append("svg")

   g.attr("id", "SVGbox-" + opt.divID)
//.attr("width", svgWidth)
...
//    .attr({'xmlns': 'http://www.w3.org/2000/svg', 'xmlns:xlink': 'http://www.w3.org/1999/xlink'});
  ...
  var needleGroup = g.append("svg:g")
    .attr("id", "needle")
