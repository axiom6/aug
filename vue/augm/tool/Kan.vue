...
<!--
      ...
      onMounted(  function() {
        nextTick( function() {
          ...
          if( mix.isDef(start) )  {
            console.log( 'Kan results', start.children ); } } ) } )

// console.log( 'Kan.onDrag()', childDrag );
// console.log( 'Kan.onDrag()', childDrag, childDrag.parentNode, childDrag.getAttribute('draggable') );
-->