...
class Surf3d extends Base
  ...
  config:() ->
    { "mapboxAccessToken":"pk.eyJ1IjoiY2hyaWRkeXAiLCJhIjoiY2lxMnVvdm5iMDA4dnhsbTQ5aHJzcGs0MyJ9.X9o_rzNLNesDxdra4neC_A", "linkText":"Export to plot.ly", "showLink":true }

  yaxis:() ->
    "domain": [0,1], "showticklabels": true,
    "showexponent": "all",
    "gridwidth": 1,
  ...
  layout: () ->
      "boxmode": "overlay", "paper_bgcolor": "#fff",
      "scene":
        "domain": { "y":[0,1], "x":[0,1] },
        "yaxis": @yaxis()
        "cameraposition": [
      ...
      "hidesources": false,
      "boxgroupgap": 0.3,
      "margin": {"b": 5,"l": 5,"r": 5,"pad": 0,"t": 5,"autoexpand": true }
