...
var __vue_render__$h = function() {
  ...
  return _c(
    ...
    [
      ...
      _vm._l(_vm.pages, function(page) {
        return [
          _c("router-view", { attrs: { name: _vm.name(page), id: page.short } })
        ]
      })
    ],
    2
