...
//
  ...
  let Dend = {
    ...
    mounted: function() {
      let that = this;
      csv$1("flare.csv", function(error, data) {
    ...
    computed: {
      ...
      root: function() {
        ...
        if (this.csv) {
          let stratify$1 = stratify().parentId(function(d) {
            return d.id.substring(0, d.id.lastIndexOf("."));
          });

          // attach the tree to the Vue data object
          return this.tree(
            stratify$1(that.csv).sort(function(a, b) {
...
var __vue_render__ = function() {
  ...
  return _c("div", [
    _c("div", { staticClass: "controls" }, [
      _c("div", [
        _c("label", { attrs: { for: "Width" } }, [_vm._v("Chart width")]),
        _vm._v(" "),
        _c("input", {
          directives: [
            {
          ...
          attrs: { id: "Width", type: "range", min: "0", max: "1000" },
      ...
      _vm._v(" "),
      _c("div", [
        _c("label", { attrs: { for: "Color" } }, [_vm._v("Stroke color")]),
        _vm._v(" "),
        _c("input", {
          directives: [
            {
          ...
          attrs: { id: "Color", type: "color" },
          domProps: { value: _vm.strokeColor },
          on: {
            input: function($event) {
              if ($event.target.composing) {
                return
              }
              _vm.strokeColor = $event.target.value;
            }
          }
        })
      ]),
      ...
      _vm._v(" "),
      _c("button", { on: { click: _vm.add } }, [_vm._v("Add node")]),
      _vm._v(" "),
      _c("div", [
          ...
          _vm._l(_vm.nodes, function(node, index) {
            return _c(
              ...
              [
                _c("circle", {
                  style: {
                    fill: index === _vm.selected ? "#ff0000" : "#bfbfbf"
                  },
                  attrs: { r: node.r }
                }),
                _vm._v(" "),
                _c(
                  "text",
                  {
                    ...
                    attrs: { dx: node.textpos.x, dy: node.textpos.y }
                  },
...
__vue_render__._withStripped = true;
  ...
  const __vue_inject_styles__ = function (inject) {
    if (!inject) return
    inject("data-v-02719ddf_0", { source: "body {\n  width: 100%;\n  height: 100%;\n  font-family: monospace;\n}\n.node {\n  opacity: 1;\n}\n.node circle {\n  fill: #999;\n  cursor: pointer;\n}\n.node text {\n  font: 10px sans-serif;\n  cursor: pointer;\n}\n.node--internal circle {\n  fill: #555;\n}\n.node--internal text {\n  text-shadow: 0 1px 0 #fff, 0 -1px 0 #fff, 1px 0 0 #fff, -1px 0 0 #fff;\n}\n.link {\n  fill: none;\n  stroke: #555;\n  stroke-opacity: 0.4;\n  stroke-width: 2px;\n  stroke-dasharray: 1000;\n}\n.node:hover {\n  pointer-events: all;\n  stroke: #ff0000;\n}\n.node.highlight {\n  fill: red;\n}\n.controls {\n  position: fixed;\n  top: 16px;\n  left: 16px;\n  background: #f8f8f8;\n  padding: 0.5rem;\n  display: flex;\n  flex-direction: column;\n}\n.controls > * + * {\n  margin-top: 1rem;\n}\nlabel {\n  display: block;\n}\n.list-enter-active,\n.list-leave-active {\n  transition: all 1s;\n}\n.list-enter,\n.list-leave-to {\n  opacity: 0;\n  transform: translateY(30px);\n}\n.line-enter-active,\n.line-leave-active {\n  transition: all 2s;\n  stroke-dashoffset: 0;\n}\n.line-enter,\n.line-leave-to {\n  stroke-dashoffset: 1000;\n}\n", map: {"version":3,"sources":["Dend.vue"],"names":[],"mappings":"AAAA;EACE,WAAW;EACX,YAAY;EACZ,sBAAsB;AACxB;AACA;EACE,UAAU;AACZ;AACA;EACE,UAAU;EACV,eAAe;AACjB;AACA;EACE,qBAAqB;EACrB,eAAe;AACjB;AACA;EACE,UAAU;AACZ;AACA;EACE,qEAAqE;AACvE;AACA;EACE,UAAU;EACV,YAAY;EACZ,mBAAmB;EACnB,iBAAiB;EACjB,sBAAsB;AACxB;AACA;EACE,mBAAmB;EACnB,eAAe;AACjB;AACA;EACE,SAAS;AACX;AACA;EACE,eAAe;EACf,SAAS;EACT,UAAU;EACV,mBAAmB;EACnB,eAAe;EACf,aAAa;EACb,sBAAsB;AACxB;AACA;EACE,gBAAgB;AAClB;AACA;EACE,cAAc;AAChB;AACA;;EAEE,kBAAkB;AACpB;AACA;;EAEE,UAAU;EACV,2BAA2B;AAC7B;AACA;;EAEE,kBAAkB;EAClB,oBAAoB;AACtB;AACA;;EAEE,uBAAuB;AACzB","file":"Dend.vue","sourcesContent":["body {\n  width: 100%;\n  height: 100%;\n  font-family: monospace;\n}\n.node {\n  opacity: 1;\n}\n.node circle {\n  fill: #999;\n  cursor: pointer;\n}\n.node text {\n  font: 10px sans-serif;\n  cursor: pointer;\n}\n.node--internal circle {\n  fill: #555;\n}\n.node--internal text {\n  text-shadow: 0 1px 0 #fff, 0 -1px 0 #fff, 1px 0 0 #fff, -1px 0 0 #fff;\n}\n.link {\n  fill: none;\n  stroke: #555;\n  stroke-opacity: 0.4;\n  stroke-width: 2px;\n  stroke-dasharray: 1000;\n}\n.node:hover {\n  pointer-events: all;\n  stroke: #ff0000;\n}\n.node.highlight {\n  fill: red;\n}\n.controls {\n  position: fixed;\n  top: 16px;\n  left: 16px;\n  background: #f8f8f8;\n  padding: 0.5rem;\n  display: flex;\n  flex-direction: column;\n}\n.controls > * + * {\n  margin-top: 1rem;\n}\nlabel {\n  display: block;\n}\n.list-enter-active,\n.list-leave-active {\n  transition: all 1s;\n}\n.list-enter,\n.list-leave-to {\n  opacity: 0;\n  transform: translateY(30px);\n}\n.line-enter-active,\n.line-leave-active {\n  transition: all 2s;\n  stroke-dashoffset: 0;\n}\n.line-enter,\n.line-leave-to {\n  stroke-dashoffset: 1000;\n}\n"]}, media: undefined });
  ...
  var Dend$1 = normalizeComponent_1(
