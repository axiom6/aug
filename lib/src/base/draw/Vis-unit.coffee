...
unit( "Vis.rgb([  0,100,100]) red",   Vis.rgb([  0,100,100]), {r:255,g:0,b:0,a:1.0} )
unit( "Vis.rgb([180,100,100]) green", Vis.rgb([180,100,100]), {r:0,g:255,b:0,a:1.0} )
unit( "Vis.rgb([270,100,100]) blue",  Vis.rgb([270,100,100]), {r:0,g:0,b:255,a:1.0} )
