...
test( "isIn(type(#{spec.toStr(resultE)}),'results')", spec.isIn(spec.type(resultE),"results"),  true )
test( "isIn(type(#{spec.toStr(resultR)}),'results')", spec.isIn(spec.type(resultR),"results"),  true )
test( "isIn(type(#{spec.toStr(resultO)}),'results')", spec.isIn(spec.type(resultO),"results"),  true )
...
test( "toSpecParse(#{objectMat})",      spec.toSpecParse(objectMat),   regexpSpec )
