...
Nav = class Nav {
  constructor(stream, mix, batch = {}, komps1 = null, pages1 = {}, isRoutes = false) {
    ...
    console.log("Nav() mix.app", this.mix.app());
    this.dirs = {
      west: true,
      east: true,
      north: true,
  ...
  doRoute(obj) {
    ...
    if ((route != null) && (this.komps != null) && (this.komps[route] != null)) {
      if (this.router != null) {
        this.router.push({
          name: route
        });
