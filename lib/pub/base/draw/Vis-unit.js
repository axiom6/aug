...
unit("rgb(0xFFFFFF)", Vis.rgb(0xFFFFFF), {
  r: 255,
  g: 255,
  b: 255,
  a: 1.0
...
unit("hex({r:255,g:255,b:255})", Vis.hex({
  r: 255,
  g: 255,
  b: 255
}), 0xFFFFFF); // Appears as 16777215 in decimal

unit("str({r:255,g:255,b:255})", Vis.str({
  r: 255,
  g: 255,
  b: 255
}), "0xFFFFFF");
...
unit("rgb([  0,100,100]) red", Vis.rgb([0, 100, 100]), {
  r: 255,
  g: 0,
  b: 0,
  a: 1.0
...
unit("rgb([180,100,100]) green", Vis.rgb([180, 100, 100]), {
  r: 0,
  g: 255,
  b: 0,
  a: 1.0
...
unit("rgb([270,100,100]) blue", Vis.rgb([270, 100, 100]), {
  r: 0,
  g: 0,
  b: 255,
  a: 1.0
