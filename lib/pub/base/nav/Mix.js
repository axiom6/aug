...
Mix = class Mix {
  ...
  isNul(d) {
    return tester.isNul(d);
  }

  isUnd(d) {
    return tester.isUnd(d);
  }

  isDef(d) {
    return tester.isDef(d);
  }

  isNot(d) {
    return tester.isNot(d);
  }

  isStr(s) {
    return tester.isStr(s);
  }
  ...
  isNum(n) {
    return tester.isNum(n);
  }

  isNaN(n) {
    return tester.isNaN(n);
  }

  isObj(o) {
    return tester.isObj(0);
  }

  inObj(o, k) {
    return tester.inObj(o, k);
  }

  toKeys(o) {
    return tester.toKeys(o);
  }

  isVal(v) {
    return tester.isVal(v);
  }

  isFunc(f) {
    return tester.isFunc(f);
  }

  isSym(s) {
    return tester.isSym(s);
  }

  isEvent(e) {
    return tester.isEvent(e);
  }

  isArray(a) {
    return tester.isArray(a);
  }

  inArray(a, e) {
    return tester.inArray(a, e);
  }

  inRange(a, i) {
    return tester.inRange(a, i);
  }

  atIndex(a, e) {
    return tester.atIndex(a, e);
  }

  head(a) {
    return tester.head(a);
  }

  tail(a) {
    return tester.tail(a);
  }
  ...
  promiseScript(src) {
    return new Promise((resolve) => {
      var j, len, script, scripts, scriptx;
  ...
  flavorJson() {
    if (Mix.Main.Batch['Flavor'] != null) {
      return Mix.Main.Batch['Flavor'].data;
    } else {
