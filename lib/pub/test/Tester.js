...
Tester = (function() {
  class Tester {
    constructor() {
      ...
      this.isSym = this.isSym.bind(this);
    ...
    isFunc(f) {
      return this.isDef(f) && this.type(f) === "function";
    }

    isSym(s) {
      return this.isDef(s) && this.type(s) === "symbol";
    }

    isEvent(e) {
      return this.isDef(e) && this.type(e) === "event";
    }
    ...
    isElement(e) {
      return this.isDef(e) && this.type(e) === 'element' && this.isDef(e['clientHeight']) && e['clientHeight'] > 0;
    }
    ...
    type1(obj) {
      var key;
      key = Object.prototype.toString.call(obj).toLowerCase();
      return Tester.typeObjects[key] || "object";
    }

  };

  Tester.prototype.type = (() => {
    var classToType, j, len1, name, ref;
    classToType = {};
    ref = ["Boolean", "Number", "String", "Function", "Object", "Array", "Date", "RegExp", "Symbol", "Event", "Element", "Undefined", "Null"];
    for (j = 0, len1 = ref.length; j < len1; j++) {
      name = ref[j];
...
Tester.types = ["Boolean", "Number", "String", "Function", "Object", "Array", "Date", "RegExp", "Symbol", "Event", "Element", "Undefined", "Null"];
...
Tester.typeObjects = {
  "boolean": Tester.typeVal("Boolean"),
  "number": Tester.typeVal("Number"),
  "string": Tester.typeVal("String"),
  "function": Tester.typeVal("Function"),
  "object": Tester.typeVal("Object"),
  "array": Tester.typeVal("Array"),
  "date": Tester.typeVal("Date"),
  "regexp": Tester.typeVal("RegExp"),
  "symbol": Tester.typeVal("Symbol"),
  "event": Tester.typeVal("Event"),
  "element": Tester.typeVal("Element"),
  "undefined": Tester.typeVal("Undefined"),
