...
Type = class Type {
  ...
  isFloat(f) {
    return (this.isType(f, "float") && !isNaN(f)) || (this.isType(i, "string") && this.isStrFloat(f));
  }

  isBoolean(b) {
    return this.isType(b, "boolean") || (this.isType(i, "string") && this.isStrBoolean(b));
  }

  isObject(o) {
    return this.isType(o, "object") || (this.isType(i, "string") && this.isStrObject(o));
  }
