...
Type = class Type {
    ...
    switch (type) {
      ...
      case "object": // This combination of travesal and recursion is cleaner than JSON.stringify()
        ...
        for (key in arg) {
          ...
          val = arg[key];
          str += key + ":" + this.toEnclose(this.toStr(val), '"') + ", ";
        }
      ...
      case "array": // This combination of travesal and recursion is cleaner than JSON.stringify()
        ...
        break;
      case "function":
        this.toInfo("toStr(arg)", "unable to convert", arg, "function", "string", "?function?", "?function?", function(t) {
          return t.log(t.info());
        });
        break;
      case "null":
      ...
      case "symbol":
        ...
        break;
      default:
        this.toInfo("toStr(arg)", "unable to convert", arg, type, "string", arg.toString(), arg.toString(), function(t) {
          return t.log(t.info());
        });
    }
    if (!this.isIn(type, "manys") && enc.length > 0) {
      return this.toEnclose(str, enc);
    } else {
      return str;
    }
  }
    ...
    switch (type) {
      ...
      case "string":
        if (this.isStringFloat(arg)) {
          ...
          return this.toInfo("toFloat(arg)", "unable to convert", arg, "string", "float", "NaN", 0/0, function(t) {
            return t.log(t.info());
          });
        }
        break;
      default:
        return this.toInfo("toFloat(arg)", "unable to convert", arg, type, "float", "NaN", 0/0, function(t) {
          return t.log(t.info());
        });
    }
  }
    ...
    switch (type) {
      ...
      case "string":
        if (this.isStringInt(arg)) {
          ...
          return this.toInfo("toInt(arg)", "unable to convert", arg, "string", "int", "NaN", 0/0, function(t) {
            return t.log(t.info());
          });
        }
        break;
      default:
        return this.toInfo("toInt(arg)", "unable to convert", arg, type, "int", "NaN", 0/0, function(t) {
          return t.log(t.info());
        });
    }
  }
      ...
      case "string":
        switch (arg) {
          ...
          case "false":
            return false;
          default:
            return this.toInfo("toBoolean(arg)", "unable to convert", arg, type, "boolean", "false", false, function(t) {
              return t.log(t.info());
            });
        }
        break;
  ...
  toArray(arg, type, sep = ",") {
    ...
    switch (type) {
      ...
      case "string":
        ...
        return array;
      default:
        return this.toInfo("toArray(arg)", "unable to convert", arg, type, "array", "[]", [], function(t) {
          return t.log(t.info());
        });
    }
  }
  ...
  toObject(arg) {
    ...
    switch (type) {
      ...
      case "string":
        ...
        break;
      default:
        this.toInfo("toObject(arg)", "unable to convert", arg, type, "object", "{}", {}, function(t) {
          return t.log(t.info());
        });
    }
    return obj;
  ...
  doInfo(info, closure, retn) {
    console.log(this);
    this.log("Type.doInfo()", "I an a logger");
    this.last = info;
    this.warn += info;
