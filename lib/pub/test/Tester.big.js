...
Tester = class Tester {
  ...
  assert(result, expect, status, level = 0, key = null, index = null) {
    ...
    isValue = function(type) {
      return this.inArray(type, ["string", "int", "float", "boolean"]);
    };
    status = (function() {
      switch (type) {
        case isValue(type):
  ...
  checkValuesTypes(result, expect, status, key, index) {
    ...
    info = (function() {
      switch (false) {
        ...
        case !(rType !== eType && eType !== ("range" || "enums")):
  ...
  isSchemaValue(type) {
    return this.inArray(type, Tester.results);
  }
...
//# sourceMappingURL=Tester.big.js.map
