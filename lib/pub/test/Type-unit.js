var a, b, e, f, func, stream, streamLog, subjects, undef;
...
test('type.toObject( {a:"x",b:"y")', type.toObject('{a:"x",b:"y")'), {
  a: '"x"',
  b: '"y"'
});
...
test('type.toObject( {a:a,b:b) var', type.toObject(`{a:${a},b:${b})`), {
  a: a,
  b: b
});
...
test('type.toObject( {a:a,b:b) val', type.toObject('{a:a,b:b)'), {
  a: a,
  b: b
});
