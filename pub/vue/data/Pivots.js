...
__vue_render__$1._withStripped = true;
  ...
  const __vue_inject_styles__$1 = function (inject) {
    if (!inject) return
    inject("data-v-77e19d0e_0", { source: ".table {\n  background-color: black;\n  justify-self: center;\n  align-self: center;\n  font-size: 1em;\n  table-layout: fixed;\n  border-collapse: collapse;\n  border: 1px solid wheat;\n}\ncaption {\n  color: wheat;\n}\nthead th {\n  color: wheat;\n  padding: 0.1em 0.2em 0.1em 0.2em;\n  border: 1px solid wheat;\n}\ntbody tr:nth-child(odd) {\n  background-color: #111111;\n}\ntbody tr:nth-child(even) {\n  background-color: #222222;\n}\ntbody tr td {\n  color: wheat;\n  padding: 0.1em 0.2em 0.1em 0.2em;\n  border: 1px solid wheat;\n}\n", map: {"version":3,"sources":["Table1.vue"],"names":[],"mappings":"AAAA;EACE,uBAAuB;EACvB,oBAAoB;EACpB,kBAAkB;EAClB,cAAc;EACd,mBAAmB;EACnB,yBAAyB;EACzB,uBAAuB;AACzB;AACA;EACE,YAAY;AACd;AACA;EACE,YAAY;EACZ,gCAAgC;EAChC,uBAAuB;AACzB;AACA;EACE,yBAAyB;AAC3B;AACA;EACE,yBAAyB;AAC3B;AACA;EACE,YAAY;EACZ,gCAAgC;EAChC,uBAAuB;AACzB","file":"Table1.vue","sourcesContent":[".table {\n  background-color: black;\n  justify-self: center;\n  align-self: center;\n  font-size: 1em;\n  table-layout: fixed;\n  border-collapse: collapse;\n  border: 1px solid wheat;\n}\ncaption {\n  color: wheat;\n}\nthead th {\n  color: wheat;\n  padding: 0.1em 0.2em 0.1em 0.2em;\n  border: 1px solid wheat;\n}\ntbody tr:nth-child(odd) {\n  background-color: #111111;\n}\ntbody tr:nth-child(even) {\n  background-color: #222222;\n}\ntbody tr td {\n  color: wheat;\n  padding: 0.1em 0.2em 0.1em 0.2em;\n  border: 1px solid wheat;\n}\n"]}, media: undefined });
...
__vue_render__$2._withStripped = true;
  ...
  const __vue_inject_styles__$4 = function (inject) {
    if (!inject) return
    inject("data-v-0e128bc4_0", { source: ".page {\n  position: absolute;\n  left: 0;\n  top: 5%;\n  right: 0;\n  bottom: 0;\n  background-color: black;\n  display: grid;\n}\n.page h1 {\n  justify-self: center;\n  align-self: center;\n  text-align: center;\n  color: wheat;\n  font-size: 3em;\n}\n", map: {"version":3,"sources":["Pivots.vue"],"names":[],"mappings":"AAAA;EACE,kBAAkB;EAClB,OAAO;EACP,OAAO;EACP,QAAQ;EACR,SAAS;EACT,uBAAuB;EACvB,aAAa;AACf;AACA;EACE,oBAAoB;EACpB,kBAAkB;EAClB,kBAAkB;EAClB,YAAY;EACZ,cAAc;AAChB","file":"Pivots.vue","sourcesContent":[".page {\n  position: absolute;\n  left: 0;\n  top: 5%;\n  right: 0;\n  bottom: 0;\n  background-color: black;\n  display: grid;\n}\n.page h1 {\n  justify-self: center;\n  align-self: center;\n  text-align: center;\n  color: wheat;\n  font-size: 3em;\n}\n"]}, media: undefined });
