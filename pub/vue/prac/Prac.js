  ...
  methods: {
    ...
    createConnect: function( stream, pracObj ) {
      this.$nextTick( function() {
        ...
        console.log( 'Conn.createConnect()', { has:this.hasElem(elem), elem:elem, refs:this.$refs } );
        if( this.isDef(elem) ) {
            ...
            directives: [
              {
                name: "show",
                rawName: "v-show",
                value: _vm.pages["Conn"].show,
                expression: "pages['Conn'].show"
              }
            ],
            attrs: { pracObj: _vm.pracObj, level: "Prac" }
          }),
          _vm._v(" "),
          _c("p-desc", {
            directives: [
