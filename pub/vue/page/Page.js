...
__vue_render__$2._withStripped = true;
  ...
  const __vue_inject_styles__$2 = function (inject) {
    if (!inject) return
    inject("data-v-10297488_0", { source: ".theme-logo {\n  background-color: black;\n  font-size: 1.5rem;\n}\n.theme-menu {\n  background-color: black;\n  font-size: 1.5rem;\n}\n.theme-find {\n  background-color: black;\n  font-size: 1.5rem;\n}\n.theme-tocs {\n  background-color: black;\n  font-size: 2.5rem;\n}\n.theme-view {\n  font-size: 1.5rem;\n}\n.theme-side {\n  background-color: black;\n  font-size: 1.5rem;\n}\n.theme-pref {\n  background-color: black;\n  font-size: 1.5rem;\n}\n.theme-foot {\n  background-color: black;\n  font-size: 1.5rem;\n}\n.theme-trak {\n  background-color: black;\n  font-size: 1.5rem;\n}\n.theme-prac {\n  background-color: #603;\n  font-size: 2rem;\n}\n.theme-icon {\n  background-color: #333;\n  border-radius: 36px;\n  width: 80%;\n  height: 90%;\n}\n.cpnn {\n  display: grid;\n  align-self: stretch;\n  justify-self: stretch;\n  align-items: center;\n  justify-items: center;\n  background-color: black;\n  color: wheat;\n  font-size: 2rem;\n  text-align: center;\n}\n", map: {"version":3,"sources":["Conn.vue","/Users/ax/Documents/prj/aug/vue/page/Conn.vue"],"names":[],"mappings":"AAAA;EACE,uBAAuB;EACvB,iBAAiB;AACnB;AACA;EACE,uBAAuB;EACvB,iBAAiB;AACnB;AACA;EACE,uBAAuB;EACvB,iBAAiB;AACnB;AACA;EACE,uBAAuB;EACvB,iBAAiB;AACnB;AACA;EACE,iBAAiB;AACnB;AACA;EACE,uBAAuB;EACvB,iBAAiB;AACnB;AACA;EACE,uBAAuB;EACvB,iBAAiB;AACnB;AACA;EACE,uBAAuB;EACvB,iBAAiB;AACnB;AACA;EACE,uBAAuB;ECCzB,iBAAA;AACA;AACA;EDCE,sBAAsB;EACtB,eAAe;AACjB;AACA;EACE,sBAAsB;EACtB,mBAAmB;EACnB,UAAU;EACV,WAAW;AACb;AACA;EACE,aAAa;EACb,mBAAmB;EACnB,qBAAqB;EACrB,mBAAmB;EACnB,qBAAqB;EACrB,uBAAuB;EACvB,YAAY;EACZ,eAAe;EACf,kBAAkB;AACpB","file":"Conn.vue","sourcesContent":[".theme-logo {\n  background-color: black;\n  font-size: 1.5rem;\n}\n.theme-menu {\n  background-color: black;\n  font-size: 1.5rem;\n}\n.theme-find {\n  background-color: black;\n  font-size: 1.5rem;\n}\n.theme-tocs {\n  background-color: black;\n  font-size: 2.5rem;\n}\n.theme-view {\n  font-size: 1.5rem;\n}\n.theme-side {\n  background-color: black;\n  font-size: 1.5rem;\n}\n.theme-pref {\n  background-color: black;\n  font-size: 1.5rem;\n}\n.theme-foot {\n  background-color: black;\n  font-size: 1.5rem;\n}\n.theme-trak {\n  background-color: black;\n  font-size: 1.5rem;\n}\n.theme-prac {\n  background-color: #603;\n  font-size: 2rem;\n}\n.theme-icon {\n  background-color: #333;\n  border-radius: 36px;\n  width: 80%;\n  height: 90%;\n}\n.cpnn {\n  display: grid;\n  align-self: stretch;\n  justify-self: stretch;\n  align-items: center;\n  justify-items: center;\n  background-color: black;\n  color: wheat;\n  font-size: 2rem;\n  text-align: center;\n}\n","\n<template>\n  <div v-show=\"isPage()\" class=\"cpnn\" prac=\"prac\" @click=\"doPrac(prac)\">\n    <i :class=\"prac.icon\"></i>\n  </div>\n</template>\n\n<script type=\"module\">\n\n  let Conn = {\n\n    props: { comp:String, prac:Object },\n\n    data() { return { page:\"None\"} },\n\n    methods: {\n\n      isPage:  function () {\n        return this.page === 'Conn'; },\n      onPage:  function (page) {\n        return this.page = page; },\n      doPrac: function (name) {\n        publish( this.comp, name ); } },\n\n    mounted: function () {\n      this.subscribe( 'Page', 'Icon.vue', (page) => this.onPage(page) ); }\n  }\n\n  export default Conn;\n\n</script>\n\n<style lang=\"less\">\n  @import '../../pub/css/themes/theme.less';\n  .cpnn { display:grid; align-self:stretch; justify-self:stretch; align-items:center; justify-items:center;\n    background-color:@theme-back; color:@theme-color; font-size:@theme-h1-size; text-align:center; }\n</style>"]}, media: undefined });
...
let Page = {
  ...
  components:{ 'p-icon':Icon$1, 'p-dirs':Dirs$1,'p-conn':Conn$1, 'p-summ':Summ$1, 'p-desc':Desc$1 },
