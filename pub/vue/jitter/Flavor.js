...
let Flavor = {
  ...
  mounted: function () {
    this.$nextTick( function() {
      ...
      this.svgMgr = new SvgMgr$1( this.name, elem, 'Flavor' );
...
var __vue_render__$1 = function() {
  ...
  var _h = _vm.$createElement;
  var _c = _vm._self._c || _h;
  return _c("div", { staticClass: "flavor-pane" }, [
    _c(
      "div",
      { staticClass: "flavor-summ" },
      [_c("h-summ", { attrs: { name: _vm.name } })],
      1
    ),
    _vm._v(" "),
    _c("div", { ref: _vm.name, staticClass: "flavor-wheel" })
  ])
};
