...
__vue_render__$2._withStripped = true;
  ...
  const __vue_inject_styles__$2 = function (inject) {
    if (!inject) return
    inject("data-v-7161a18e_0", { source: ".theme-logo {\n  background-color: black;\n  font-size: 1.5rem;\n}\n.theme-menu {\n  background-color: black;\n  font-size: 1.5rem;\n}\n.theme-find {\n  background-color: black;\n  font-size: 1.5rem;\n}\n.theme-tocs {\n  background-color: black;\n  font-size: 2.5rem;\n}\n.theme-view {\n  font-size: 1.5rem;\n}\n.theme-side {\n  background-color: black;\n  font-size: 1.5rem;\n}\n.theme-pref {\n  background-color: black;\n  font-size: 1.5rem;\n}\n.theme-foot {\n  background-color: black;\n  font-size: 1.5rem;\n}\n.theme-trak {\n  background-color: black;\n  font-size: 1.5rem;\n}\n.theme-prac {\n  background-color: #603;\n  font-size: 2rem;\n}\n.theme-icon {\n  background-color: #333;\n  border-radius: 36px;\n  width: 80%;\n  height: 90%;\n}\n.choice {\n  position: absolute;\n  left: 0;\n  top: 0;\n  width: 100%;\n  height: 100%;\n  background-color: black;\n  color: wheat;\n}\n.choice .csumm {\n  position: absolute;\n  left: 0;\n  top: 0;\n  width: 100%;\n  height: 15%;\n}\n.choice .cbtns {\n  position: absolute;\n  left: 0;\n  top: 15%;\n  width: 100%;\n  height: 85%;\n  background-color: black;\n  color: wheat;\n}\n", map: {"version":3,"sources":["Body.vue","/Users/ax/Documents/prj/aug/vue/jitter/Body.vue"],"names":[],"mappings":"AAAA;EACE,uBAAuB;EACvB,iBAAiB;AACnB;AACA;EACE,uBAAuB;EACvB,iBAAiB;AACnB;AACA;EACE,uBAAuB;EACvB,iBAAiB;AACnB;AACA;EACE,uBAAuB;EACvB,iBAAiB;AACnB;AACA;EACE,iBAAiB;AACnB;AACA;EACE,uBAAuB;EACvB,iBAAiB;AACnB;AACA;EACE,uBAAuB;EACvB,iBAAiB;AACnB;AACA;EACE,uBAAuB;EACvB,iBAAiB;AACnB;AACA;EACE,uBAAuB;EACvB,iBAAiB;AACnB;AACA;EACE,sBAAsB;EACtB,eAAe;AACjB;AACA;EACE,sBAAsB;EACtB,mBAAmB;EACnB,UAAU;EACV,WAAW;AACb;ACCA;EDCE,kBAAkB;ECCpB,OAAA;EACA,MAAA;EDCE,WAAW;ECCb,YAAA;EDCE,uBAAuB;ECCzB,YAAA;AACA;AACA;EDCE,kBAAkB;EAClB,OAAO;EACP,MAAM;EACN,WAAW;EACX,WAAW;AACb;AACA;EACE,kBAAkB;EAClB,OAAO;EACP,QAAQ;EACR,WAAW;EACX,WAAW;EACX,uBAAuB;EACvB,YAAY;AACd","file":"Body.vue","sourcesContent":[".theme-logo {\n  background-color: black;\n  font-size: 1.5rem;\n}\n.theme-menu {\n  background-color: black;\n  font-size: 1.5rem;\n}\n.theme-find {\n  background-color: black;\n  font-size: 1.5rem;\n}\n.theme-tocs {\n  background-color: black;\n  font-size: 2.5rem;\n}\n.theme-view {\n  font-size: 1.5rem;\n}\n.theme-side {\n  background-color: black;\n  font-size: 1.5rem;\n}\n.theme-pref {\n  background-color: black;\n  font-size: 1.5rem;\n}\n.theme-foot {\n  background-color: black;\n  font-size: 1.5rem;\n}\n.theme-trak {\n  background-color: black;\n  font-size: 1.5rem;\n}\n.theme-prac {\n  background-color: #603;\n  font-size: 2rem;\n}\n.theme-icon {\n  background-color: #333;\n  border-radius: 36px;\n  width: 80%;\n  height: 90%;\n}\n.choice {\n  position: absolute;\n  left: 0;\n  top: 0;\n  width: 100%;\n  height: 100%;\n  background-color: black;\n  color: wheat;\n}\n.choice .csumm {\n  position: absolute;\n  left: 0;\n  top: 0;\n  width: 100%;\n  height: 15%;\n}\n.choice .cbtns {\n  position: absolute;\n  left: 0;\n  top: 15%;\n  width: 100%;\n  height: 85%;\n  background-color: black;\n  color: wheat;\n}\n","\n<template>\n  <div   class=\"choice\">\n    <div class=\"csumm\">\n      <h-summ name=\"Body\" id=\"CBody\" ></h-summ>\n    </div>\n    <div class=\"cbtns\">\n      <h-btns comp=\"Body\" :btns=\"btns\" :choicea=\"choicea\" back=\"#3B5999\" active=\"tan\"></h-btns>\n    </div>\n  </div>\n</template>\n\n<script type=\"module\">\n\n  import Summ from './Summ.vue';\n  import Btns from '../../vue/elem/Btns.vue';\n\n  let Body = {\n\n    components:{ 'h-summ':Summ, 'h-btns':Btns },\n\n    data() { return { comp:'Body', choicea:['','',''], btns:{\n      Thick:  { title:'Thick',  name:'Thick',  pos:[20, 5,60,14], back:'primary',   check:true },\n      Full:   { title:'Full',   name:'Full',   pos:[20,24,60,14], back:'secondary', check:true },\n      Creamy: { title:'Creamy', name:'Creamy', pos:[20,43,60,14], back:'success',   check:true },\n      Milky:  { title:'Milky',  name:'Milky',  pos:[20,62,60,14], back:'info',      check:true },\n      Silky:  { title:'Silky',  name:'Silky',  pos:[20,81,60,14], back:'warning',   check:true }\n    } } },\n    \n    methods:{},\n\n    beforeMount: function () {\n      this.choicea[0] = this.choice()['Body'].c0;\n      this.choicea[1] = this.choice()['Body'].c1;\n      this.choicea[2] = this.choice()['Body'].c2;\n    }\n\n  }\n\n  export default Body;\n\n</script>\n\n<style lang=\"less\">\n  \n  @import '../../pub/css/themes/theme.less';\n  \n  .choice { position:absolute; left:0; top:0; width:100%; height:100%;\n    background-color:@theme-back; color:@theme-color;\n    \n    .csumm { position:absolute; left:0; top:0; width:100%; height:15%; }\n    \n    .cbtns { position:absolute; left:0; top:15%; width:100%; height:85%;\n             background-color:@theme-back; color:@theme-color; }\n  }\n\n</style>\n"]}, media: undefined });
