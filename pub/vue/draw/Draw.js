...
let Draw = {
  ...
  mounted: function () {
    ...
    this.mix().subscribe(  'Nav', 'Draw.vue', (obj) => {
      this.onNav(obj); } );
    this.$nextTick( function() {
      this.D3D = new D3D$1( this.mix().stream() ); } ); }
};

/* script */
const __vue_script__$1 = Draw;
...
var __vue_render__$1 = function() {
  ...
  return _c(
    ...
    [
      ...
      _vm._v(" "),
      _vm.pageKey === "Draw" ? _c("h1", [_vm._v("Drawings in D3")]) : _vm._e(),
      _vm._v(" "),
