...
let Comp = {
  ...
  data() { return {
    comp:'None', prac:'All', disp:'All', page:'None', practices:{},
    pages:[
  ...
  methods: {
    stPage: function (page) {
      return this.page === page ? { display:'grid' } : { display:'none' }; },
    isPage: function (page) {
      return this.nav().page === page; },
      ...
      _vm._l(_vm.practices, function(prac) {
        return [
          _c(
            ...
            [
              _c("p-icon", {
                style: _vm.stPage("Icon"),
                attrs: { comp: _vm.comp, prac: prac }
              }),
              _vm._v(" "),
              _c("p-dirs", {
                style: _vm.stPage("Dirs"),
                attrs: { comp: _vm.comp, prac: prac }
              }),
              _vm._v(" "),
              _c("p-summ", {
                style: _vm.stPage("Summ"),
                attrs: { comp: _vm.comp, prac: prac }
              }),
              _vm._v(" "),
              _c("p-desc", {
                style: _vm.stPage("Desc"),
                attrs: { comp: _vm.comp, prac: prac }
              })
            ],
            1
