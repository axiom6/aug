...
let Comp = {
  ...
  data() { return { compKey:'None', compObj:null, pracObj:{}, myRows:{}, inovKey:'None',
    ...
    infos:{
      Info: { title:'Information',  key:"Info", show:true,  icon:"fas fas fa-th"         },
      Soft: { title:'Software',     key:"Soft", show:false, icon:"fas fas fa-codepen"    },
      Data: { title:'Data',         key:"Data", show:false, icon:"fas fas fa-table"      } },
    knows:{
      Know: { title:'Knowledge',    key:"Know", show:true,  icon:"fas fas fa-university" },
      Scie: { title:'Science',      key:"Scie", show:false, icon:"fas fa-flask"          },
      Math: { title:'Math',         key:"Math", show:false, icon:"fas fa-table"          } },
    wises:{
      Wise: { title:'Wisdom',       key:"Wise", show:true, icon:"fas fas fa-tripadvisor" } },
    rows: {
...
var __vue_render__$6 = function() {
  ...
  return _c(
    ...
    [
      ...
      _vm.hasInovs()
        ? _c("b-tabs", {
            attrs: { route: "Inov", pages: _vm.inovPages(), position: "right" }
          })
        : _vm._e(),
      _vm._v(" "),
      _c(
