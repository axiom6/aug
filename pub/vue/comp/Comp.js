...
let Comp = {
  ...
  methods: {
    pagesKey: function(route) {
      let key = 'pages';
      if(           route  ==='Comp' ) { key = 'pages'; }
      else if( this.compKey==='Info' ) { key = 'infos'; }
      else if( this.compKey==='Know' ) { key = 'knows'; }
      else if( this.compKey==='Wise' ) { key = 'wises'; }
      return key; },
  ...
  return _c(
    ...
    [
      _c("b-tabs", {
        attrs: {
          route: "Comp",
          pagesKey: _vm.pagesKey("Comp"),
          pages: _vm.tabPages("Comp"),
          position: "left"
        }
      }),
      _vm._v(" "),
      _vm.hasInovs()
        ? _c("b-tabs", {
            attrs: {
              route: "Inov",
              pagesKey: _vm.pagesKey("Inov"),
              pages: _vm.tabPages("Inov"),
              position: "right"
            }
          })
        : _vm._e(),
