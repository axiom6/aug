...
TestMathML = class TestMathML extends MathML {
  ...
  testMarkup() {
    var add1ML, equ1ML, equ2ML, exps, fun1ML, int1ML, key, lim1ML, mat1ML, mul1ML, mul2ML, mul3ML, obj, sin1ML, sin2ML, status, sub1ML, sub2ML, sum1ML, sum2ML, sum3ML, tan1ML, vec1ML;
  ...
  testParse(key) {
    var addML, exps, obj, status, susML, trgML;
    addML = "";
    trgML = "";
    susML = "";
    exps = {
