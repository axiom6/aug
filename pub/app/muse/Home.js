...
let Disp$2 = {
  ...
  components:{ 'd-tabs':Tabs, 'd-desc':Desc$3 },
...
__vue_render__$j._withStripped = true;
  ...
  const __vue_inject_styles__$j = function (inject) {
    if (!inject) return
    inject("data-v-47977cb4_0", { source: ".theme-prac {\n  background-color: #333;\n  border-radius: 36px;\n  width: 90%;\n  height: 90%;\n  font-size: 2rem;\n}\n.theme-comp-icon {\n  background-color: #333;\n  border-radius: 36px;\n  width: 90%;\n  height: 90%;\n}\n.theme-comp-dirs {\n  background-color: #333;\n  border-radius: 36px;\n  width: 90%;\n  height: 90%;\n  font-size: 1.3rem;\n}\n.theme-prin-dirs {\n  background-color: #333;\n  border-radius: 36px;\n  width: 90%;\n  height: 90%;\n  font-size: 2rem;\n}\n.theme-comp-conn {\n  background-color: #333;\n  border-radius: 36px;\n  width: 90%;\n  height: 90%;\n}\n.theme-comp-desc {\n  background-color: #333;\n}\n.theme-prac-dirs {\n  background-color: #333;\n  border-radius: 36px;\n  font-size: 3.9rem;\n}\n.theme-prac-conn {\n  background-color: #333;\n  border-radius: 36px;\n}\n.theme-prac-desc {\n  background-color: #333;\n}\n.theme-disp-desc {\n  background-color: #333;\n  font-size: 2rem;\n}\n.theme-logo {\n  background-color: black;\n  font-size: 1.5vmin;\n}\n.theme-menu {\n  background-color: black;\n  font-size: 1.5vmin;\n}\n.theme-find {\n  background-color: black;\n  font-size: 1.5vmin;\n}\n.theme-tocs {\n  background-color: black;\n  font-size: 2rem;\n}\n.theme-view {\n  background-color: black;\n  font-size: 1.5vmin;\n}\n.theme-side {\n  background-color: black;\n  font-size: 1.5vmin;\n}\n.theme-pref {\n  background-color: black;\n  font-size: 1.5vmin;\n}\n.theme-foot {\n  background-color: black;\n  font-size: 1.5vmin;\n}\n.theme-trak {\n  background-color: black;\n  font-size: 1.5vmin;\n}\n.disd {\n  position: relative;\n  left: 0;\n  top: 0;\n  right: 0;\n  bottom: 0;\n  background-color: #333;\n}\n", map: {"version":3,"sources":["Disp.vue","/Users/ax/Documents/prj/aug/vue/disp/Disp.vue"],"names":[],"mappings":"AAAA;EACE,sBAAsB;EACtB,mBAAmB;EACnB,UAAU;EACV,WAAW;EACX,eAAe;AACjB;AACA;EACE,sBAAsB;EACtB,mBAAmB;EACnB,UAAU;EACV,WAAW;AACb;AACA;EACE,sBAAsB;EACtB,mBAAmB;EACnB,UAAU;EACV,WAAW;EACX,iBAAiB;AACnB;AACA;EACE,sBAAsB;EACtB,mBAAmB;EACnB,UAAU;EACV,WAAW;EACX,eAAe;AACjB;AACA;EACE,sBAAsB;EACtB,mBAAmB;EACnB,UAAU;EACV,WAAW;AACb;AACA;EACE,sBAAsB;AACxB;AACA;EACE,sBAAsB;EACtB,mBAAmB;EACnB,iBAAiB;AACnB;AACA;EACE,sBAAsB;EACtB,mBAAmB;AACrB;AACA;EACE,sBAAsB;AACxB;ACCA;EDCE,sBAAsB;ECCxB,eAAA;ADCA;AACA;EACE,uBAAuB;EACvB,kBAAkB;AACpB;AACA;EACE,uBAAuB;EACvB,kBAAkB;AACpB;AACA;EACE,uBAAuB;EACvB,kBAAkB;AACpB;AACA;EACE,uBAAuB;EACvB,eAAe;AACjB;AACA;EACE,uBAAuB;EACvB,kBAAkB;AACpB;AACA;EACE,uBAAuB;EACvB,kBAAkB;AACpB;AACA;EACE,uBAAuB;EACvB,kBAAkB;AACpB;AACA;EACE,uBAAuB;EACvB,kBAAkB;AACpB;AACA;EACE,uBAAuB;EACvB,kBAAkB;AACpB;AACA;EACE,kBAAkB;EAClB,OAAO;EACP,MAAM;EACN,QAAQ;EACR,SAAS;EACT,sBAAsB;AACxB","file":"Disp.vue","sourcesContent":[".theme-prac {\n  background-color: #333;\n  border-radius: 36px;\n  width: 90%;\n  height: 90%;\n  font-size: 2rem;\n}\n.theme-comp-icon {\n  background-color: #333;\n  border-radius: 36px;\n  width: 90%;\n  height: 90%;\n}\n.theme-comp-dirs {\n  background-color: #333;\n  border-radius: 36px;\n  width: 90%;\n  height: 90%;\n  font-size: 1.3rem;\n}\n.theme-prin-dirs {\n  background-color: #333;\n  border-radius: 36px;\n  width: 90%;\n  height: 90%;\n  font-size: 2rem;\n}\n.theme-comp-conn {\n  background-color: #333;\n  border-radius: 36px;\n  width: 90%;\n  height: 90%;\n}\n.theme-comp-desc {\n  background-color: #333;\n}\n.theme-prac-dirs {\n  background-color: #333;\n  border-radius: 36px;\n  font-size: 3.9rem;\n}\n.theme-prac-conn {\n  background-color: #333;\n  border-radius: 36px;\n}\n.theme-prac-desc {\n  background-color: #333;\n}\n.theme-disp-desc {\n  background-color: #333;\n  font-size: 2rem;\n}\n.theme-logo {\n  background-color: black;\n  font-size: 1.5vmin;\n}\n.theme-menu {\n  background-color: black;\n  font-size: 1.5vmin;\n}\n.theme-find {\n  background-color: black;\n  font-size: 1.5vmin;\n}\n.theme-tocs {\n  background-color: black;\n  font-size: 2rem;\n}\n.theme-view {\n  background-color: black;\n  font-size: 1.5vmin;\n}\n.theme-side {\n  background-color: black;\n  font-size: 1.5vmin;\n}\n.theme-pref {\n  background-color: black;\n  font-size: 1.5vmin;\n}\n.theme-foot {\n  background-color: black;\n  font-size: 1.5vmin;\n}\n.theme-trak {\n  background-color: black;\n  font-size: 1.5vmin;\n}\n.disd {\n  position: relative;\n  left: 0;\n  top: 0;\n  right: 0;\n  bottom: 0;\n  background-color: #333;\n}\n","\n<template>\n  <div class=\"disd\">\n    <d-tabs route=\"Disp\" :pages=\"pages\"></d-tabs>\n    <d-desc v-if=\"pages['Desc'].show\" :dispObj=\"dispObj\"></d-desc>\n  </div>\n</template>\n\n<script type=\"module\">\n\n  import Tabs from '../elem/Tabs.vue';\n  import Desc from './Desc.vue';\n  \n  let Disp = {\n\n    components:{ 'd-tabs':Tabs, 'd-desc':Desc },\n    \n    data() { return { compKey:'Desc', dispObj:null,\n      pages:{\n        Desc: { title:'Descriptions', key:'Desc', show:true } } } },\n    \n    methods: {\n      \n      onDisp: function(dispKey) {\n        this.dispObj  = this.dispObject( this.nav().compKey, this.nav().pracKey, dispKey );\n        if( !this.isDef(this.dispObj) ) {\n          console.error('Disp.onDisp() disp null',{comp:this.nav().compKey,prac:this.nav().pracKey,disp:dispKey})}},\n      doPage: function( pageKey ) {\n        this.nav().setPageKey( 'Disp', pageKey ); },\n      onNav:  function (obj) {\n        if( this.nav().isMyNav( obj, 'Disp' ) ) {\n            this.onDisp( obj.dispKey ); } } },\n\n    beforeMount: function() {\n      this.onDisp( this.nav().dispKey ); },\n\n    mounted: function () {\n      this.doPage( this.nav().getPageKey('Disp','Desc') );\n      this.subscribe(  \"Nav\", 'Disp.vue', (obj) => {\n        this.onNav(obj); } ); }\n  }\n  \n  export default Disp;\n  \n</script>\n\n<style lang=\"less\">\n  \n  @import '../../pub/css/themes/theme.less';\n\n  .disd { position:relative; left:0; top:0; right:0; bottom:0; background-color:@theme-icon-back; }\n  \n</style>\n\n"]}, media: undefined });
