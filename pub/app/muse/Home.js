...
var __vue_render__$f = function() {
  ...
  return _c(
    "div",
    { staticClass: "sect-pane" },
    [
      _vm.hasProp("icon")
        ? _c("div", { staticClass: "sect-icon" }, [
            _c("i", { class: _vm.getProp("icon") })
          ])
        : _vm._e(),
      _vm._v(" "),
      _vm.hasProp("banner")
      ...
      _vm.hasProp("desc")
        ? _c("div", { staticClass: "sect-desc" }, [
            _vm._v(_vm._s(_vm.getProp("desc")))
          ])
        : _vm._e(),
      _vm._v(" "),
      _vm.isType("Prac")
        ? _c("t-prac", {
            staticClass: "sect-prac",
            attrs: { sectObj: _vm.sectObj, pracObj: _vm.dataObj }
          })
        : _vm._e(),
      _vm._v(" "),
      _vm.isType("Disp")
        ? _c("t-disp", {
            staticClass: "sect-disp",
            attrs: { sectObj: _vm.sectObj, dispObj: _vm.dataObj }
          })
        : _vm._e(),
      _vm._v(" "),
      _vm.hasProp("author")
