...
__vue_render__._withStripped = true;
  ...
  const __vue_inject_styles__ = function (inject) {
    if (!inject) return
    inject("data-v-574786bd_0", { source: "\n.wood {\n  position:relative; width: 100%; height: 100%; min-height: 700px; overflow:hidden; background-color: #041e2b;\n  background-image: linear-gradient(to bottom, #041e2b 0%, #407886 41%, #d4dbdb 69%, black 69%, black 100%);\n}\n.wood .moon {  position:absolute; left:25%; top:100px;\n}\n.wood .horseman {\n    position: absolute; left:50%; top:300px; width:184px; height:123px; margin-left: -100px;\n    background: url(\"../../pub/svg/horse-hallow5.svg\");\n    animation: horsemove 0.7s steps(15) infinite;\n}\n.wood .ground {\n    position: absolute; left:0; top:0; width:151%; height:697px;\n    background-size: 800px, 716px;\n    transform: translateZ(0);\n    backface-visibility: hidden;\n    perspective: 1000px;\n}\n.wood .front {\n    background: url(\"../../pub/svg/hallowfront4.svg\") repeat-x;\n    background-size: 1000px 871px;\n    top: -100px;\n    animation: bk 20s -5s linear infinite;\n}\n.wood .frontmid {\n    background: url(\"../../pub/svg/hallowmidfront2.svg\") repeat-x;\n    background-size: 1000px 871px;\n    top: -100px;\n    animation: bk 50s -5s linear infinite;\n}\n.wood .mid {\n    background: url(\"../../pub/svg/hallowmid2.svg\") repeat-x;\n    background-size: 1000px 871px;\n    top: -100px;\n    animation: bk 100s -5s linear infinite;\n}\n.wood .back {\n    background: url(\"../../pub/svg/hallowback2.svg\") repeat-x;\n    background-size: 1000px 871px;\n    top: -100px;\n    animation: bk 100s -5s linear infinite;\n}\n@keyframes horsemove {\n100% {\n      background-position: 0 -1848px;\n}\n}\n@keyframes bk {\n100% {\n      background-position: -200% 0;\n}\n}\n  \n\n", map: {"version":3,"sources":["/Users/ax/Documents/prj/aug/ani/wood/Wood.vue"],"names":[],"mappings":";AAuBA;EACA,iBAAA,EAAA,WAAA,EAAA,YAAA,EAAA,iBAAA,EAAA,eAAA,EAAA,yBAAA;EACA,yGAAA;AAAA;AAEA,eAAA,iBAAA,EAAA,QAAA,EAAA,SAAA;AAAA;AAEA;IACA,kBAAA,EAAA,QAAA,EAAA,SAAA,EAAA,WAAA,EAAA,YAAA,EAAA,mBAAA;IACA,kDAAA;IACA,4CAAA;AAAA;AAEA;IACA,kBAAA,EAAA,MAAA,EAAA,KAAA,EAAA,UAAA,EAAA,YAAA;IACA,6BAAA;IACA,wBAAA;IACA,2BAAA;IACA,mBAAA;AAAA;AAEA;IACA,0DAAA;IACA,6BAAA;IACA,WAAA;IACA,qCAAA;AAAA;AAEA;IACA,6DAAA;IACA,6BAAA;IACA,WAAA;IACA,qCAAA;AAAA;AAEA;IACA,wDAAA;IACA,6BAAA;IACA,WAAA;IACA,sCAAA;AAAA;AAEA;IACA,yDAAA;IACA,6BAAA;IACA,WAAA;IACA,sCAAA;AAAA;AAEA;AACA;MACA,8BAAA;AAAA;AAAA;AAEA;AACA;MACA,4BAAA;AAAA;AAAA","file":"Wood.vue","sourcesContent":["\n<template>\n  <div class=\"wood\">\n    <svg class=\"moon\" xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 100 100\" width=\"100\" height=\"100\">\n      <circle r=\"30\" fill=\"#fff\" cx=\"70\" cy=\"70\" ></circle>\n    </svg>\n    <div class=\"back ground\"></div>\n    <div class=\"mid ground\"></div>\n    <div class=\"frontmid ground\"></div>\n    <div class=\"front ground\"></div>\n    <div class=\"horseman\"></div>\n  </div>\n</template>\n\n<script>\n  export default {\n  \n  };\n\n</script>\n\n<style>\n  \n.wood {\n  position:relative; width: 100%; height: 100%; min-height: 700px; overflow:hidden; background-color: #041e2b;\n  background-image: linear-gradient(to bottom, #041e2b 0%, #407886 41%, #d4dbdb 69%, black 69%, black 100%); }\n\n  .wood .moon {  position:absolute; left:25%; top:100px; }\n\n  .wood .horseman {\n    position: absolute; left:50%; top:300px; width:184px; height:123px; margin-left: -100px;\n    background: url(\"../../pub/svg/horse-hallow5.svg\");\n    animation: horsemove 0.7s steps(15) infinite; }\n\n  .wood .ground {\n    position: absolute; left:0; top:0; width:151%; height:697px;\n    background-size: 800px, 716px;\n    transform: translateZ(0);\n    backface-visibility: hidden;\n    perspective: 1000px; }\n\n.wood .front {\n    background: url(\"../../pub/svg/hallowfront4.svg\") repeat-x;\n    background-size: 1000px 871px;\n    top: -100px;\n    animation: bk 20s -5s linear infinite; }\n\n.wood .frontmid {\n    background: url(\"../../pub/svg/hallowmidfront2.svg\") repeat-x;\n    background-size: 1000px 871px;\n    top: -100px;\n    animation: bk 50s -5s linear infinite; }\n\n.wood .mid {\n    background: url(\"../../pub/svg/hallowmid2.svg\") repeat-x;\n    background-size: 1000px 871px;\n    top: -100px;\n    animation: bk 100s -5s linear infinite; }\n\n.wood .back {\n    background: url(\"../../pub/svg/hallowback2.svg\") repeat-x;\n    background-size: 1000px 871px;\n    top: -100px;\n    animation: bk 100s -5s linear infinite; }\n  \n  @keyframes horsemove {\n    100% {\n      background-position: 0 -1848px; } }\n  \n  @keyframes bk {\n    100% {\n      background-position: -200% 0; } }\n  \n\n</style>\n\n"]}, media: undefined });
